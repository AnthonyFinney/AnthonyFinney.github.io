...
export default function Hero({
    ...
    return (
        <section
            id="hero"
            className="relative overflow-hidden flex items-center justify-center min-h-[calc(100vh-4rem)] px-6 py-16 text-white bg-transparent"
        >
            ...
            <div className="relative container mx-auto border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_0_60px_rgba(0,0,0,0.45)] p-10 rounded-[32px]">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div className="order-2 md:order-1 text-center md:text-left">
                        <p className="uppercase tracking-[0.5em] text-xs md:text-sm text-[#d9c38c]">
                            Crafted in code
                        </p>
                        ...
                        <p className="mt-3 text-sm md:text-base text-gray-300 max-w-xl md:max-w-none">
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8">
                            <a
                                ...
                                className="inline-flex items-center gap-3 border border-[#d9c38c] px-6 py-3 uppercase tracking-[0.35em] text-xs text-[#d9c38c] hover:bg-[#d9c38c]/10 transition"
                            >
                                <SiGithub size={24} /> GitHub
                            </a>
                            <a
                                href="https://www.linkedin.com/in/soshie-finney-557361233/"
                                className="inline-flex items-center gap-3 border border-[#2e9faa] px-6 py-3 uppercase tracking-[0.35em] text-xs text-[#2e9faa] hover:bg-[#2e9faa]/10 transition"
                            >
